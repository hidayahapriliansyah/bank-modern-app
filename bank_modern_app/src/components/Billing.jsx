  ...
  return (
    <section id="product" className={`${layout.sectionReverse}`}>
      ...
      <div className={`${layout.sectionInfo}`}>
        ...
        <p className={`${styles.paragraph} max-w-[450px] mt-5`}>Elit enim sed massa etiam. Mauris eu adipiscing ultrices ametodio aenean neque. Fusce ipsum orci rhoncus aliporttitor integer platea placerat.</p>
